...
const JustBecause = () => {
  return (
    <div className="flex justify-between gap-4 max-w-[744px] bg-white text-[#1C1C1C]">
        <div className="flex flex-col gap-4 w-3/5 p-12 justify-between">
            <div>
                ...
                <div className="mb-6 font-normal text-base text-[#4F4F4F]">
                    <p>Congratulations on ..... [Recipient&apos;s Name]! To mark this important moment, a donation has been made in your honor to support [Project Name] at MKE. Your achievement is creating a lasting impact and bringing hope to children who need it most.</p>
                </div>
            </div>
            <div>
            Best of luck,<br />
        ...
        <div className="w-3/5">
            <Image src="/images/justbecause.svg" alt="justbecause" width={100} height={100} className="w-full h-auto"/>
        </div>
    </div>
  )
}
